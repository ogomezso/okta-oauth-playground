...
cat <<EOF > oidc-teamaadmin.properties
# oidc-admin.properties
...
sasl.jaas.config=org.apache.kafka.common.security.oauthbearer.OAuthBearerLoginModule required \
    ...
    extension_identityPoolId='$TEAMAADMIN_IDP' \
    scope='$TEAMAADMIN_SCOPE';
...
kafka-topics --bootstrap-server $CCLOUD_BOOTSTRAP --command-config oidc-teamaadmin.properties --create --topic teama-anything