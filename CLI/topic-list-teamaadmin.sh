...
cat <<EOF > oidc-teambadmin.properties
...
sasl.jaas.config=org.apache.kafka.common.security.oauthbearer.OAuthBearerLoginModule required \
    ...
    extension_identityPoolId='$TEAMBADMIN_IDP'
    scope='$TEAMBADMIN_SCOPE';
...
kafka-topics --bootstrap-server $CCLOUD_BOOTSTRAP --command-config oidc-teambadmin.properties --list