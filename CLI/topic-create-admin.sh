...
sasl.jaas.config=org.apache.kafka.common.security.oauthbearer.OAuthBearerLoginModule required \
    ...
    extension_identityPoolId='$ADMIN_IDP' \
    scope='$ADMIN_SCOPE';
...
kafka-topics --bootstrap-server $CCLOUD_BOOTSTRAP --command-config oidc-admin.properties --create --topic anyname-topic